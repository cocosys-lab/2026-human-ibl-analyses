...
# N.B. The cursor position could be recorded for up to 506ms after the response window time out at 10s. 
# This was always registered as a no-response and feedback was given accordingly, 
# even if the cursor crossed the response threshold in the extra samples. 
# We therefore remove the extra samples here and recode the response time as a nan,
# rather than keeping it as a value >10s.
